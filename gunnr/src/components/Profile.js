        ...
        <div className="users show">
            <div className="container-fluid main-container">
                ...
                <div className="posts-wrapper animated fadeInUp" data-animation="fadeInUp-fadeOutDown">
                    ...
                    {items.profile.weapons.map((weapon) =>
                        <div className="post-panel">
                            ...
                            {weapon.feature_img.length > 0 ? <div className="post-picture-wrapper">
                                <img src={weapon.feature_img} alt="alt" />
                            </div> : ''}
                            ...
                            <div className="main-body">
                                ...
                                <a className="read-more" href={`/weaponview/${weapon._id}`}>Read more</a>
                            </div>
